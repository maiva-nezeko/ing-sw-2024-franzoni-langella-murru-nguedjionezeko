...
public class TableTest extends TestCase {
    ...
    public TableTest(String testName)
    {
        ...
        testCorrectDeckCreation();
        testPlayer_CorrectReturnValuesAndSetters();
        testTable_CorrectDeckOperations();
    }


    public void testCorrectDeckCreation() {
    ...
    public void testPlayer_CorrectReturnValuesAndSetters()
    {
        ...
        assertArrayEquals(testPlayer.getPrivateCardsID(), new int[] {41, 20, -30, 205, 105, 102});
        ...
        assertArrayEquals(testPlayer.getPrivateCardsID(), new int[] {0, -20, -30, 205, 105, 102});

        //test for correct ScoreBoard setting and interaction
        testPlayer.setScoreBoard(new int[]{0, 1,2,3,4, 5,6,7});
        assertArrayEquals(testPlayer.getScoreBoard(), new int[]{0, 1,2,3,4, 5,6,7});
