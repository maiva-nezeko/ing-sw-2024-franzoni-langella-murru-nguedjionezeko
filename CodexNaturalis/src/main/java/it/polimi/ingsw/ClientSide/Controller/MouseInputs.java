 ...
 * Lets the player play from the mouse combing inputs with actions
...
public class MouseInputs implements MouseListener, MouseMotionListener {
    ...
    /**
     * spot the movement of the mouse with no button pushed
    ...
    /**
     * spot the crawling of the mouse
     * @param e  the event generated by the player
     * */
