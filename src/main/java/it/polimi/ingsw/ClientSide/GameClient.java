...
/**
 * The Game client class to send and receive data.
 */
public class GameClient extends Thread{
     ...
     *
     * @param game          the game to instantiate
     * @param ipAddress_str the ip address of the Client as a string
     */
     ...
     * @return the confirmation or reply message as a string
     */
     ...
     *
     * @param data to send as a byte array
     */
